...
/*
* db den gelen bir deger var mi?
* burda bos bir data gelmesi gerekiyor dogru geldi mi?
* bu degiskenin degeri true mu?
* gelen sayi degeri negatif bir sayi mi?
* ...
* ...
* bu gibi olaylarda bekledigimiz sekilde sonuclar gelmezse hatalar firlatiyoruz
* checkResult un amacida bu, parametre olarak gonderilen kontrol yontemine gore sarti kontrol ediyor
* eger saglamiyor ise hata firlatiyor
*
* */
